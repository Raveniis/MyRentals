        ...
        <div class="card shadow mb-3">
                    ...
                    <div class="row" style="margin-bottom: 25px;text-align: left;">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" value="{{ $tenant->emergency_num }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" value="{{ $tenant->employment_status }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" value="{{ $tenant->monthly_income }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" value="{{ $tenant->move_in_date }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" value="{{ $tenant->lease_term }} months" readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" value="{{ $tenant->occupants_number }} people" readonly>
                            </div>
                        </div>
            ...
            <div class="card-body">
                ...
                <form>
                    <div class="row" style="margin-bottom: 25px;text-align: left;">
                        <div class="col-sm-4 col-md-4 col-lg-3 col-xl-2 col-xxl-2" style="display: inline;text-align: center;margin-bottom: 25px;">
                                <img id="previewImage" class="rounded-circle mb-3 mt-4 img-fluid" src="{{ asset($tenant->houseRental->image) }}" style=" display: inline; max-height: 150px; width: 200px; height: 200px; border-radius: 0px !important;">
                            </div>                        
                            <div class="col-sm-8 col-md-8 col-lg-9 col-xl-10 col-xxl-10 align-self-center">
                            <div class="row">
                                <div class="col-md-12 text-start">
                                    <div class="mb-3"><label class="form-label" for="email"><strong>Rental Name</strong></label>
                                    <input class="form-control" value="{{ $tenant->houseRental->name}}" readonly>
                                </div>
                                </div>
                                <div class="col-md-12 text-start">
                                    <div class="mb-3"><label class="form-label" for="username"><strong>Address</strong></label>
                                    <input class="form-control" type="text" value="{{ $tenant->houseRental->address }}" readonly></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" value="{{ $tenant->houseRental->monthly_rent }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" value="{{ $tenant->houseRental->maximum_occupants }}" readonly>
                            </div>
                        </div>
                </form>
            </div>  
